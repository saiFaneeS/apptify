...
import { ScrollText, Feather, Book } from "lucide-react";
      ...
      <div className="relative max-w-7xl mx-auto py-24 px-4 sm:pb-20 sm:pt-44 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-3">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-lg font-medium">1000+ Chronicles</h3>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-lg font-medium">500+ Tome Reviews</h3>
              <p className="mt-2 text200">
          ...
          <div className="flex items-center">
            <Feather className="h-12 w-12 text300" />
            <div className="ml-4">
              <h3 className="text-lg font-medium">10 Learned Scribes</h3>
              <p className="mt-2 text200">
                Masters of the quill and ink
              </p>
            </div>
          </div>
        </div>
