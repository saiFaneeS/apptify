...
const socialLinks = [
  { name: "Ye Olde Twitter", icon: Feather, href: "https://twitter.com" },
    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-b from100 to200 flex items-center justify-center px-4 py-12 pt-24">
        <div className="max-w-3xl w-full">
          <div className="bg50 border-4 border900 rounded-lg shadow-2xl overflow-hidden">
            <div className="p-8 md:p-12">
              <h1 className="text-4xl md:text-5xl font-bold text900 mb-6 text-center">
                Hark! Connect with Our Realm
              </h1>
              <p className="text-lg text800 mb-8 text-center">
                Though we've no scroll for thee to pen thy thoughts, fear not!
                Our realm extends beyond these digital borders. Seek us out in
              ...
              <div className="mt-12 text-center">
                ...
                <p className="text-xl text900">
                  Send a raven to:
                </p>
                <p className="text-lg font-medium text800">
                  Ye Olde Blog Castle, Digital Realm, Internet Kingdom
                </p>
              </div>
            </div>
            <div className="bg900 text100 py-4 px-8 text-center">
              <p className="text-sm">
                Crafted with quill and parchment by the Digital Scribes Guild ©{" "}
